...
class _ActivityScreenState extends State<ActivityScreen>
  ...
  final List<String> _notifications =
      List.generate((20), (index) => "${index}h");
  ...
  late final Animation<Color?> _overlayAnimation = ColorTween(
    begin: Colors.transparent,
    end: Colors.black38,
  ).animate(_animationController);

  void onDismissed(String noti) {
          ...
          ListView(
            ...
            children: [
              ...
              for (var noti in _notifications)
                Dismissible(
                  key: Key(noti),
                  onDismissed: (direction) => {onDismissed(noti)},
